...
🚀 Features
    ...
    🎬 Automatic video rendering using Manim

    ☁️ Uploads rendered videos to Cloudinary

    📁 Organized structure for script generation and media storage
